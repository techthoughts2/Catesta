...
1. Create your CodeBuild project(s) in your AWS account. While you can do this manually, using the CloudFormation (CFN) template generated by Catesta is recommended.
    * **GitHub**
